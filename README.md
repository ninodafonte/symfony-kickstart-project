...
Here in this [blog post](https://dafonte.dev/2020/07/30/kickstart-symfony-project-dev-and-production-in-20-minutes.html), you'll find all the details about the "why" and "how" of this project so if you want to know more, or you run into trouble using it, please refer to that page to make sure you know the details.  

I'll keep in this README the necessary steps to have the environments running leaving the detailed explanation and customizations in the [blog post](https://dafonte.dev/2020/07/30/kickstart-symfony-project-dev-and-production-in-20-minutes.html).
...
If there is any doubt about any of these parameters please take a look at the [blog post](https://dafonte.dev/2020/07/30/kickstart-symfony-project-dev-and-production-in-20-minutes.html) mentioned above, there is an in-deep explanation of the whole system.
...
In the [blog post](https://dafonte.dev/2020/07/30/kickstart-symfony-project-dev-and-production-in-20-minutes.html) you'll find the detailed explanation about how this works but here's what you need to know in order to enable continuous integration in your repo.
